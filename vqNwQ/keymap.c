...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_GRAVE,       KC_TRANSPARENT, KC_TRANSPARENT, KC_AMPR,        KC_LCBR,        KC_RCBR,                                        KC_7,           TD(DANCE_8),    KC_9,           KC_PLUS,        KC_ASTR,        KC_F12,         
    KC_TRANSPARENT, TD(DANCE_4),    TD(DANCE_5),    TD(DANCE_6),    TD(DANCE_7),    KC_RPRN,                                        KC_4,           KC_5,           KC_6,           TD(DANCE_9),    KC_SLASH,       KC_BSPC,        
