...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_GRAVE,       KC_TRANSPARENT, KC_TRANSPARENT, KC_AMPR,        KC_LCBR,        KC_RCBR,                                        KC_7,           DUAL_FUNC_5,    DUAL_FUNC_6,    DUAL_FUNC_7,    KC_ASTR,        KC_F12,         
    KC_TRANSPARENT, DUAL_FUNC_1,    DUAL_FUNC_2,    DUAL_FUNC_3,    DUAL_FUNC_4,    KC_RPRN,                                        KC_4,           KC_5,           KC_6,           TD(DANCE_2),    KC_SLASH,       KC_BSPC,        
  ...
  [2] = LAYOUT_voyager(
    ...
    MAC_LOCK,       KC_TRANSPARENT, KC_TRANSPARENT, HSV_0_255_255,  HSV_74_255_255, HSV_169_255_255,                                LCTL(LSFT(KC_TAB)),ST_MACRO_0,     ST_MACRO_1,     ST_MACRO_2,     KC_TRANSPARENT, LCTL(LSFT(KC_SPACE)),
                                                    TD(DANCE_3),    KC_ESCAPE,                                      KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_voyager(
    TD(DANCE_4),    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_6),    
    ...
    TD(DANCE_5),    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_7),    
                                                    KC_BSPC,        KC_TRANSPARENT,                                 KC_TRANSPARENT, LT(4, KC_SPACE)
  ),
  [4] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, TD(DANCE_8),    TD(DANCE_9),    TD(DANCE_10),   KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [6] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 ST_MACRO_3,     KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_4,     KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [7] = LAYOUT_voyager(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,                                          KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         
...
const uint16_t PROGMEM combo9[] = { MT(MOD_LGUI, KC_D), MT(MOD_LSFT, KC_F), MT(MOD_RSFT, KC_J), COMBO_END};
const uint16_t PROGMEM combo10[] = { MT(MOD_RSFT, KC_J), MT(MOD_RGUI, KC_K), MT(MOD_LSFT, KC_F), COMBO_END};
  ...
  case QK_MODS ... QK_MODS_MAX: 
    ...
    case DUAL_FUNC_5:
      if (record->tap.count > 0) {
        ...
        if (record->event.pressed) {
          register_code16(LGUI(LCTL(KC_U)));
        } else {
          unregister_code16(LGUI(LCTL(KC_U)));
        }  
      }  
      return false;
    case DUAL_FUNC_6:
      if (record->tap.count > 0) {
        ...
        if (record->event.pressed) {
          register_code16(LALT(LCTL(KC_I)));
        } else {
          unregister_code16(LALT(LCTL(KC_I)));
        }  
      }  
      return false;
    case DUAL_FUNC_7:
      if (record->tap.count > 0) {
        ...
        if (record->event.pressed) {
          register_code16(LALT(LCTL(KC_O)));
        } else {
          unregister_code16(LALT(LCTL(KC_O)));
        }  
      }  
      return false;
    case DUAL_FUNC_8:
